...
export const interpretingCopyByLang: Record<UiLanguage, InterpretingCopy> = {
  UA: {
    ...
    heroBreadcrumbAriaLabel: "Навігація: послуги",
  ...
  RU: {
    ...
    heroBreadcrumbAriaLabel: "Навигация: услуги",
  ...
  EN: {
    ...
    heroBreadcrumbAriaLabel: "Breadcrumb: services",
  ...
  DE: {
    ...
    heroBreadcrumbAriaLabel: "Brotkrumen: Leistungen",
    ctaOrder: "Übersetzung anfragen",
    ctaMore: "Mehr erfahren",
    heroTitle: "Dolmetschen",
    heroBadge: "PREISRECHNER",
    topicsBadge: "Leistungstypen",
